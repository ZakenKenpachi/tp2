...
namespace CMIYC
{
    ...
    public static class PathFinder
    {
        ...
        private static void ComputeCosts(Grid aMaze, int fromX, int fromY, int[,] costs)
        {
        ...
        /// <param name="fromX">La position en X ou se trouve l'opposant</param>
        /// <param name="fromY">La position en Y ou se trouve l'opposant</param>
        /// <param name="toX">La position en X ou se trouve le hero</param>
        /// <param name="toY">La position en Y ou se trouve le hero</param>
        ...
        private static Direction RecurseFindDirection(int[,] costs, int fromX, int fromY, int toX, int toY)
        {
            ...
            if (toX < costs.GetLength(0) && toY < costs.GetLength(1) && toX >= 1 && toY >= 1
                && fromX < costs.GetLength(0) && fromY < costs.GetLength(1) && fromX >= 1 && fromY >= 1)
            {
